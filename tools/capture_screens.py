...
from ib_cmc.screens.fixation_instruction_screen import build_fixation_instruction_stims  # noqa: E402
...
def main() -> None:
    ...
    try:
        ...
        if not args.no_aux:
            ...
            snap(win, build_fixation_instruction_stims(win, config), out_dir / "aux_fixation_instruction.png")
